...
export type userReducerAction = {
	type:
		| typeof userActionTypes.GET_USER_START
		| typeof userActionTypes.SET_USER
		| typeof userActionTypes.GET_USER_FAILURE;
	payload: any;
};

// action type in shopping cart
export type shoppingCartAction = {
	type: typeof NEW_ITEM_ADDED | typeof ITEM_REMOVED | typeof SINGLE_ITEM_REMOVED;
	payload: shopItem;
};
